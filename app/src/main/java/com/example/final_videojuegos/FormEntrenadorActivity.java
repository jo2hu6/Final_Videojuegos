...
public class FormEntrenadorActivity extends AppCompatActivity {
    ...
    private void solicitarPermisos(){
        if(this.checkSelfPermission(Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) //SI ES QUE LA CAMARA NO TIENE EL PERMISO
        {
            requestPermissions(new String[] { Manifest.permission.CAMERA }, 10001);
        }
        if(this.checkSelfPermission(Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) //SI ES QUE LA CAMARA NO TIENE EL PERMISO
        {
